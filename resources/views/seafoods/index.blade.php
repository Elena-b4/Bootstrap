            ...
            <table class="table table-hover">
                ...
                @foreach($seafoods as $seafood)
                    <tr class="text-center">
                        <th scope="row">{{ $seafood->id }}</th>
                        <td><a href="{{ route('seafoods.show', $seafood->id) }}">{{ $seafood->title }}</a></td>
                        <td>{{ $seafood->price . ' руб' }}</td>
                        <td><a href="{{ route('seafoods.edit', $seafood->id) }}">
                        ...
                        <td><a href="{{ route('seafoods.delete', $seafood->id) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                    <path fill-rule="evenodd"
